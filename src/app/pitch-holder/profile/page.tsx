...
export default function PitchHolderProfile() {
  ...
  return (
    <>
      <PageHeader title="Profile" subtitle="Your details and preferences." />
      ...
      <div className="max-w-[560px]">
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-5">
          ...
          <Field id="pf-pitch" label="Pitch (set by campsite)">
            <input
              id="pf-pitch"
              value={`${pitch.code} · ${pitch.area} · ${pitch.site}`}
              disabled
          ...
          <div className="flex items-center justify-between gap-4 border-y border-border py-5">
            <div>
              ...
              <p className="mt-0.5 text-[13px] text-muted">
                A gentle nudge at 21:00 to log the night.
              </p>
            </div>
            <Switch
              checked={reminder}
